...
export function CreateAdModal() {
  ...
  async function handleCreateAd(event:FormEvent) {
    ...
    try {
      await axios.post(`http://localhot:3333/games/${data.game}/ads`, {
      name: data.name,
            ...
            <Dialog.Content>
              <form className="mt-8 flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <Input name="name" id="name" type="text" placeholder="Digite seu nickname do jogo" />
                </div>

                <div className="grid grid-cols-2 gap-6">
                  <div className="flex flex-col gap-2">
                    <label htmlFor="yerasPlaying">Joga há quantos anos?</label>
                    <Input type="number" name="yearsPlaying" id="yearsPlaying" placeholder="Ha quanto tempo joga o game?"/>
                  </div>
                  <div className="flex flex-col gap-2">
                ...
                <div className="flex gap-6">
                  <div className="flex flex-col gap-2">
                    <label htmlFor="weekDays">Quando costuma jogar?</label>
                     ...
                     <ToggleGroup.Root type="multiple" className="grid grid-cols-4 gap-2" onValueChange={setWeekDays}>               
                      ...
                      <ToggleGroup.Item value="2" title="Terca" className={`w-8 h-8 rounded  ${weekDays.includes('2')? 'bg-violet-500':'bg-zinc-900'}` }>T</ToggleGroup.Item>
                  ...
                  <div className="flex flex-col gap-2 flex-1">
                    <label htmlFor="hourStart">Qual horarios costuma jogar?</label>
